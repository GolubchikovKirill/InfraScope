...
class CashRegister(SQLModel, table=True):
    id: uuid.UUID = Field(default_factory=uuid.uuid4, primary_key=True)
    source_order: int | None = Field(default=None, index=True)
    location_zone: str | None = Field(default=None, max_length=8, index=True)
    ...
    sber_store_code: str | None = Field(default=None, max_length=64, index=True)
    ...
    rosenzweig_number: str | None = Field(default=None, max_length=64, index=True)
    ...
    second_screen: str | None = Field(default=None, max_length=64)
    piot_status: str | None = Field(default=None, max_length=128, index=True)
    cash_drawer: str | None = Field(default=None, max_length=512)
    terminal_status: str | None = Field(default=None, max_length=128, index=True)
