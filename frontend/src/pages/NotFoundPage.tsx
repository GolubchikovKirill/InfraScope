  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="app-panel w-full max-w-xl p-8 text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[var(--brand-strong)] to-[var(--brand-bright)] text-white shadow-lg">
          <Compass className="h-7 w-7" />
        </div>
        <div className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--danger-fg)]">Error 404</div>
